---
style: slides
cover: slides/for_build/for_engineers.001.jpeg
description: 'Security Training for the Build Teams', ZappiStore's internal employee technical security training, open to all Build function employees as part of our continuous security training program.
pdf: /assets/pdf/zappistore_security_training_for_build_public.pdf
---

!!!info "Security Training for Build Function"
    Security Training for the Build Teams', ZappiStore's internal employee technical security training, open to all Build function employees as part of our continuous security training program. 

    Unlike our course [for everyone](/for_everyone/), this course covers more technical topics and is more applicable to those in a build role. While it delves into various technical topics, it has been designed in such a way as it should be useful regardless of your skill level, whether you've just started your build career, or you've been doing this for years.

    While some of the material we present internally contains sensitive ZappiStore information, the majority consists of generic security lessons, presented in a light-hearted and informative way. This site is the culmination of our efforts to do just that.

---

### Introduction

<input type="checkbox" id="001" /><label for="001">![001](../slides/for_build/for_engineers.001.png)</label>
_001. "Security Training for Build, 2018"_

Welcome to "Security Training for Build". This talk is specifically geared towards engineers and other I.T. technical roles, and is going to be a bit more technical than the [training for everyone](/for_everyone/). If you're not an I.T. technical role though, don't worry, you're more than welcome to stay. While the topics will be technical in nature, it should be informative no matter what your skill level is, whether you're just getting started, or are a seasoned engineer with years of experience. We have received some inspiration from our fellow Cadres at PagerDuty and forked our work of them.

<input type="checkbox" id="002" /><label for="002">![002](../slides/for_build/for_engineers.002.png)</label>
_001. "Security Guys, 2018"_

For those who've not met me yet, "Hi, I'm Hati (on the left)" and Mark runs the show on this side of the court (on the right). I work on all things around continuously improving security at ZappiStore. So my job is to be the guy who has to worry about what could go wrong so you can push on those value adds at ZappiStore. My simple security views are: Make security easy, Make change happen, Automate the repetative stuff and make humans focus on the more fun stuff, We all have a part to play in LEAGUE OF EXTRA-ORDINARY DEVELOPER, Transparency is key to continuous improvement, People over process, Everyday there is something new to learn and Assumptions form the first step of making something insecure, ask questions even if they feel stupid.
...
<input type="checkbox" id="004" /><label for="004">![004](../slides/for_build/for_engineers.004.jpeg)</label>
_004. Goal of the training._

So why are you all here today? The goal of today's training is to give you the opportunity to learn about a variety of common security vulnerabilities that are relevant when developing software and maintaining software. I'm not just going to show you what they are, and how to stop them, but I'm also going to show you how to exploit them too. Exploiting these vulnerabilities is usually the best way to really learn how they work, and is an important part of knowing how to stop them. Plus it's more fun to show you how to exploit them.

---

### Topics

<input type="checkbox" id="005" /><label for="005">![005](../slides/for_build/for_engineers.005.jpeg)</label>
...
<input type="checkbox" id="006" /><label for="006">![006](../slides/for_build/for_engineers.006.jpeg)</label>
_006. Warning sign._
...
Because even though frameworks are great, they are not immune to security issues (Spoiler: No software is immune to security issues). If a new vulnerability is publicly announced, you can't always just sit around and wait for an official patch. You will need the knowledge of how the security vulnerability works so that you can patch it yourself. Because attackers aren't going to wait around, they're going to start exploiting them immediately. Regardless of the fact that we have decentralized security teams (`#security penguins`), it is really great to take concern and understanding of security vulnerabilities. You can always join the `#penguin` channel and discuss cool stuff.
...
<input type="checkbox" id="009" /><label for="009">![009](../slides/for_build/for_engineers.009.jpeg)</label>
...
### SecuritySprint (If only that existed)

<input type="checkbox" id="010" /><label for="010">![010](../slides/for_build/for_engineers.010.jpeg)</label>
_010. It's just for a Hackday._

Another statement I hear occasionally is "It's just temporary implementation which we will fix later", often used as an excuse for attempting to ignore security best practices.

---

### Story Time

_<input type="checkbox" id="012" /><label for="012">![012](../slides/for_build/for_engineers.012.jpeg)</label>_
_012. Story Time._
...
<input type="checkbox" id="021" /><label for="021">![021](../slides/for_build/for_engineers.021.jpeg)</label>
...
_<input type="checkbox" id="023" /><label for="023">![023](../slides/for_build/for_engineers.023.jpeg)</label>_
...
<input type="checkbox" id="024" /><label for="024">![024](../slides/for_build/for_engineers.024.jpeg)</label>
...
<input type="checkbox" id="025" /><label for="025">![025](../slides/for_build/for_engineers.025.jpeg)</label>
...
<input type="checkbox" id="026" /><label for="026">![026](../slides/for_build/for_engineers.026.jpeg)</label>
...
<input type="checkbox" id="027" /><label for="027">![027](../slides/for_build/for_engineers.027.jpeg)</label>
...
<input type="checkbox" id="028" /><label for="028">![028](../slides/for_build/for_engineers.028.jpeg)</label>
...
<input type="checkbox" id="029" /><label for="029">![029](../slides/for_build/for_engineers.029.jpeg)</label>
...
<input type="checkbox" id="030" /><label for="030">![030](../slides/for_build/for_engineers.030.jpeg)</label>
...
<input type="checkbox" id="031" /><label for="031">![031](../slides/for_build/for_engineers.031.jpeg)</label>
...
<input type="checkbox" id="032" /><label for="032">![032](../slides/for_build/for_engineers.032.jpeg)</label>
...
<input type="checkbox" id="033" /><label for="033">![033](../slides/for_build/for_engineers.033.jpeg)</label>
...
<input type="checkbox" id="034" /><label for="034">![034](../slides/for_build/for_engineers.034.jpeg)</label>
_034. Lookup by ID._
...
<input type="checkbox" id="035" /><label for="035">![035](../slides/for_build/for_engineers.035.jpeg)</label>
...
<input type="checkbox" id="036" /><label for="036">![036](../slides/for_build/for_engineers.036.jpeg)</label>
_036. Wildcard._
...
<input type="checkbox" id="037" /><label for="037">![037](../slides/for_build/for_engineers.037.jpeg)</label>
_037. Union._
...
<input type="checkbox" id="038" /><label for="038">![038](../slides/for_build/for_engineers.038.jpeg)</label>
_038. Load file._
...
<input type="checkbox" id="039" /><label for="039">![039](../slides/for_build/for_engineers.039.jpeg)</label>
...
<input type="checkbox" id="040" /><label for="040">![040](../slides/for_build/for_engineers.040.jpeg)</label>
_040. Boolean._
...
<input type="checkbox" id="041" /><label for="041">![041](../slides/for_build/for_engineers.041.jpeg)</label>
_041. Time-Based._
...
<input type="checkbox" id="042" /><label for="042">![042](../slides/for_build/for_engineers.042.jpeg)</label>
_042. Escaping?_
...
<input type="checkbox" id="043" /><label for="043">![043](../slides/for_build/for_engineers.043.jpeg)</label>
...
<input type="checkbox" id="044" /><label for="044">![044](../slides/for_build/for_engineers.044.jpeg)</label>
...
<input type="checkbox" id="045" /><label for="045">![045](../slides/for_build/for_engineers.045.jpeg)</label>
...
<input type="checkbox" id="046" /><label for="046">![046](../slides/for_build/for_engineers.046.jpeg)</label>
...
<input type="checkbox" id="047" /><label for="047">![047](../slides/for_build/for_engineers.047.jpeg)</label>
...
<input type="checkbox" id="048" /><label for="048">![048](../slides/for_build/for_engineers.048.jpeg)</label>
...
<input type="checkbox" id="049" /><label for="049">![049](../slides/for_build/for_engineers.049.jpeg)</label>
_049. Benefits._
...
<input type="checkbox" id="050" /><label for="050">![050](../slides/for_build/for_engineers.050.jpeg)</label>
...
<input type="checkbox" id="051" /><label for="051">![051](../slides/for_build/for_engineers.051.jpeg)</label>
...
### Storing Passwords
### Note that for most of the cases in Rails, password storage is managed for you using `Devise` but also going forward, all client facing web applications should make use of User Management as an authentication pipeline.


_<input type="checkbox" id="052" /><label for="052">![052](../slides/for_build/for_engineers.052.jpeg)</label>_
...
<input type="checkbox" id="053" /><label for="053">![053](../slides/for_build/for_engineers.053.jpeg)</label>
...
<input type="checkbox" id="054" /><label for="054">![054](../slides/for_build/for_engineers.054.jpeg)</label>
...
<input type="checkbox" id="055" /><label for="055">![055](../slides/for_build/for_engineers.055.jpeg)</label>
...
<input type="checkbox" id="056" /><label for="056">![056](../slides/for_build/for_engineers.056.jpeg)</label>
_056. Salting?_
...
<input type="checkbox" id="057" /><label for="057">![057](../slides/for_build/for_engineers.057.jpeg)</label>
...
<input type="checkbox" id="058" /><label for="058">![058](../slides/for_build/for_engineers.058.jpeg)</label>
...
<input type="checkbox" id="059" /><label for="059">![059](../slides/for_build/for_engineers.059.jpeg)</label>
...
<input type="checkbox" id="060" /><label for="060">![060](../slides/for_build/for_engineers.060.jpeg)</label>
_060. Database._
...
<input type="checkbox" id="061" /><label for="061">![061](../slides/for_build/for_engineers.061.jpeg)</label>
...
<input type="checkbox" id="062" /><label for="062">![062](../slides/for_build/for_engineers.062.jpeg)</label>
...
<input type="checkbox" id="063" /><label for="063">![063](../slides/for_build/for_engineers.063.jpeg)</label>
...
<input type="checkbox" id="064" /><label for="064">![064](../slides/for_build/for_engineers.064.jpeg)</label>
_064. Pepper._
...
<input type="checkbox" id="065" /><label for="065">![065](../slides/for_build/for_engineers.065.jpeg)</label>
_065. Slow down!_
...
<input type="checkbox" id="066" /><label for="066">![066](../slides/for_build/for_engineers.066.jpeg)</label>
...
<input type="checkbox" id="067" /><label for="067">![067](../slides/for_build/for_engineers.067.jpeg)</label>
...
<input type="checkbox" id="068" /><label for="068">![068](../slides/for_build/for_engineers.068.jpeg)</label>
...
<input type="checkbox" id="069" /><label for="069">![069](../slides/for_build/for_engineers.069.jpeg)</label>
...
<input type="checkbox" id="070" /><label for="070">![070](../slides/for_build/for_engineers.070.jpeg)</label>
...
<input type="checkbox" id="071" /><label for="071">![071](../slides/for_build/for_engineers.071.jpeg)</label>
...
<input type="checkbox" id="072" /><label for="072">![072](../slides/for_build/for_engineers.072.jpeg)</label>
_072. Use bcrypt._
...
<input type="checkbox" id="073" /><label for="073">![073](../slides/for_build/for_engineers.073.jpeg)</label>
...
<input type="checkbox" id="074" /><label for="074">![074](../slides/for_build/for_engineers.074.jpeg)</label>
...
_<input type="checkbox" id="075" /><label for="075">![075](../slides/for_build/for_engineers.075.jpeg)</label>_
_075. Encryption._
...
<input type="checkbox" id="076" /><label for="076">![076](../slides/for_build/for_engineers.076.jpeg)</label>
...
<input type="checkbox" id="077" /><label for="077">![077](../slides/for_build/for_engineers.077.jpeg)</label>
...
<input type="checkbox" id="078" /><label for="078">![078](../slides/for_build/for_engineers.078.jpeg)</label>
...
<input type="checkbox" id="079" /><label for="079">![079](../slides/for_build/for_engineers.079.jpeg)</label>
...
<input type="checkbox" id="080" /><label for="080">![080](../slides/for_build/for_engineers.080.jpeg)</label>
...
<input type="checkbox" id="081" /><label for="081">![081](../slides/for_build/for_engineers.081.jpeg)</label>
...
<input type="checkbox" id="082" /><label for="082">![082](../slides/for_build/for_engineers.082.jpeg)</label>
...
<input type="checkbox" id="083" /><label for="083">![083](../slides/for_build/for_engineers.083.jpeg)</label>
...
<input type="checkbox" id="084" /><label for="084">![084](../slides/for_build/for_engineers.084.jpeg)</label>
...
<input type="checkbox" id="085" /><label for="085">![085](../slides/for_build/for_engineers.085.jpeg)</label>
...
<input type="checkbox" id="086" /><label for="086">![086](../slides/for_build/for_engineers.086.jpeg)</label>
...
<input type="checkbox" id="087" /><label for="087">![087](../slides/for_build/for_engineers.087.jpeg)</label>
_087. Data classification._

A quick reminder of our data classification policy. We have three distinct types of data at ZappiStore.

* **RED (Confidential) = Not for Disclosure**

Red should be used when information disclosure could lead to significant impact to the company or individuals privacy, reputation, or operations if misused. Recipients may not share RED information with any parties outside of the specific exchange, meeting, or conversation in which it was originally disclosed. In the context of a meeting, for example, RED information is limited to those present at the meeting. In most circumstances, RED should be exchanged verbally or in person. If electronic means of communication are used, the classification and the words "NOT FOR FURTHER DISTRIBUTION" should be clearly displayed.

* **AMBER (Restricted) = Limited disclosure, within a specific internal group**

Amber should be used for information that carries risks to privacy, reputation, or operations if shared outside of the individuals or organizations involved. Recipients may only share AMBER information with members of their own organization, and with clients, partners or customers who need to know the information in a way agreed to by the business, as part of an established business process. Information owners are at liberty to specify additional intended limits of the sharing: these must be adhered to. All personal information is considered AMBER and should be labelled accordingly. When communicating AMBER information electronically, appropriate protection should be used.

* **GREEN (Limited) = Limited disclosure, within a general group or groups**

Green should be used for information useful for the awareness of all participating employees within the organisation as well as with third party organisations where there is a clear business need. Recipients may share GREEN information internally and with third parties where suitable non-disclosure agreements exist, but not via publicly accessible channels. Information in this category can be circulated widely within a particular group. GREEN information may not released outside of a group without explicit consent. Information owners are at liberty to specify additional intended limits of the sharing: these must be adhered to.

Personal information and Customer data is by far the most valuable and protected data we have at ZappiStore, and is subject to our most stringent security rules.

---

### Data Handling

<input type="checkbox" id="088" /><label for="088">![088](../slides/for_build/for_engineers.088.jpeg)</label>
_088. Data handling._

How we handle data depends on what type of data it is. For example, GREED data does not need to be encrypted, as it's considered public. All other types of data should always be encrypted in transit and at rest however.

You can view a more detailed description of our data handling policies on our [Data Classification Policy](https://zigroup.atlassian.net/wiki/spaces/ISMS/pages/87461358/ISM5+Data+Classification+Policy).

---

### Customer Data

<input type="checkbox" id="089" /><label for="089">![089](../slides/for_build/for_engineers.089.jpeg)</label>
...
<input type="checkbox" id="090" /><label for="090">![090](../slides/for_build/for_engineers.090.jpeg)</label>
_090. AWS encryption. [Reference](https://aws.amazon.com/blogs/security/tag/server-side-encryption/)_

Our tooling takes care of most of this for you, but there are some edge cases where you may need to select a specific option to enable it yourself. Especially if you're using new services or tools in AWS, please make sure they're encrypted. It’s usually just a single click, and is super easy to enable.

We typically get notified if you create a new unencrypted resource, and your newly created object will likely get terminated or you’ll get a notification from DevOps/Security. So save yourself the hassle and always enable encryption.

---

### Third-Party Systems

<input type="checkbox" id="091" /><label for="091">![091](../slides/for_build/for_engineers.091.jpeg)</label>
...
So please make sure to get a vendor risk assessment completed before you try and start using a third-party tool. Get a hold of the security team to organize an assessment and we will gladly help.

---

### Encryption - Additional Reading

<input type="checkbox" id="092" /><label for="092">![092](../slides/for_build/for_engineers.092.jpeg)</label>
...
_<input type="checkbox" id="093" /><label for="093">![093](../slides/for_build/for_engineers.093.jpeg)</label>_
_093. Caption._
...
<input type="checkbox" id="094" /><label for="094">![094](../slides/for_build/for_engineers.094.jpeg)</label>
...
<input type="checkbox" id="095" /><label for="095">![095](../slides/for_build/for_engineers.095.jpeg)</label>
_095. Secrets?_
...
<input type="checkbox" id="096" /><label for="096">![096](../slides/for_build/for_engineers.096.jpeg)</label>
_096. ಠ_ಠ_
...
### Distributed Encrypted Configurations Packs

<input type="checkbox" id="097" /><label for="097">![097](../slides/for_build/for_engineers.097.jpeg)</label>
_097. Vault._

So how should secrets be stored? You need a dedicated system for managing them. Just like how you use password managers to manage passwords, you should use a secret manager to manage secrets. We use numerous approachs for handling secrets at ZappiStore, given your use case, please consult the Security Team for a strategy available to manage your secret.

### Need The Password

<input type="checkbox" id="100" /><label for="100">![100](../slides/for_build/for_engineers.100.jpeg)</label>
...
Very rarely is there a "password" for something that needs to be shared. We should all have individual accounts to things so that we have accountability. So the question should really be _"I need access to..."_ instead. Even then, if a secret needs to be shared, it needs to be done the correct way. Ideally send this request to `changes@zappistore.com` for assistance.

---

### Never Share Secrets Insecurely

<input type="checkbox" id="101" /><label for="101">![101](../slides/for_build/for_engineers.101.jpeg)</label>
...
<input type="checkbox" id="102" /><label for="102">![102](../slides/for_build/for_engineers.102.jpeg)</label>
...
<input type="checkbox" id="103" /><label for="103">![103](../slides/for_build/for_engineers.103.jpeg)</label>
...
<input type="checkbox" id="104" /><label for="104">![104](../slides/for_build/for_engineers.104.jpeg)</label>
...
<input type="checkbox" id="105" /><label for="105">![105](../slides/for_build/for_engineers.105.jpeg)</label>
...
Ideally look for a way to redact anything that even remotely looks like a secret or reach out to the Security Team.

---

### Be Mindful of What You Log

<input type="checkbox" id="106" /><label for="106">![106](../slides/for_build/for_engineers.106.jpeg)</label>
...
<input type="checkbox" id="107" /><label for="107">![107](../slides/for_build/for_engineers.107.jpeg)</label>
...
_<input type="checkbox" id="108" /><label for="108">![108](../slides/for_build/for_engineers.108.jpeg)</label>_
...
<input type="checkbox" id="109" /><label for="109">![109](../slides/for_build/for_engineers.109.jpeg)</label>
...
<input type="checkbox" id="110" /><label for="110">![110](../slides/for_build/for_engineers.110.jpeg)</label>
...
<input type="checkbox" id="111" /><label for="111">![111](../slides/for_build/for_engineers.111.jpeg)</label>
...
<input type="checkbox" id="112" /><label for="112">![112](../slides/for_build/for_engineers.112.jpeg)</label>
_112. Uh oh!_
...
<input type="checkbox" id="113" /><label for="113">![113](../slides/for_build/for_engineers.113.jpeg)</label>
...
<input type="checkbox" id="114" /><label for="114">![114](../slides/for_build/for_engineers.114.jpeg)</label>
...
<input type="checkbox" id="115" /><label for="115">![115](../slides/for_build/for_engineers.115.jpeg)</label>
...
<input type="checkbox" id="116" /><label for="116">![116](../slides/for_build/for_engineers.116.jpeg)</label>
...
<input type="checkbox" id="117" /><label for="117">![117](../slides/for_build/for_engineers.117.jpeg)</label>
_117. HTML._
...
<input type="checkbox" id="118" /><label for="118">![118](../slides/for_build/for_engineers.118.jpeg)</label>
_118. Ember. [Reference](https://gist.github.com/jamesarosen/478db5faef370eac43fb)_

So how to you do this encoding? It depends on the language you're using. We use a lot of Rails here at ZappiStore, and in Rails you just need to add encoding to the config/yml files like `encoding: utf8` in your `database.yml` config or for most specs `YOUR-STRING.force_encoding('UTF-8')`. So you need to be very careful that you use the appropriate method.
...
<input type="checkbox" id="120" /><label for="120">![120](../slides/for_build/for_engineers.120.jpeg)</label>
...
<input type="checkbox" id="121" /><label for="121">![121](../slides/for_build/for_engineers.121.jpeg)</label>
...
<input type="checkbox" id="122" /><label for="122">![122](../slides/for_build/for_engineers.122.jpeg)</label>
...
<input type="checkbox" id="123" /><label for="123">![123](../slides/for_build/for_engineers.123.jpeg)</label>
...
_<input type="checkbox" id="124" /><label for="124">![124](../slides/for_build/for_engineers.124.jpeg)</label>_
...
<input type="checkbox" id="125" /><label for="125">![125](../slides/for_build/for_engineers.125.jpeg)</label>
_125. Definition._
...
<input type="checkbox" id="126" /><label for="126">![126](../slides/for_build/for_engineers.126.jpeg)</label>
...
<input type="checkbox" id="127" /><label for="127">![127](../slides/for_build/for_engineers.127.jpeg)</label>
_127. Forum._

We have a forum where people can post comments. Here you can see a user called Kelly has posted some comments, and now the attacker (that's us) is going to add one too.

---

### Posting an Image

<input type="checkbox" id="128" /><label for="128">![128](../slides/for_build/for_engineers.128.jpeg)</label>
...
<input type="checkbox" id="129" /><label for="129">![129](../slides/for_build/for_engineers.129.jpeg)</label>
...
<input type="checkbox" id="130" /><label for="130">![130](../slides/for_build/for_engineers.130.jpeg)</label>
_130. Kelly._

When Kelly visits the page, they're going to see a broken link. But in the background, their browser made a request to get the image. Let's see what's happening behind the scenes...

---

### Behind The Scenes

<input type="checkbox" id="131" /><label for="131">![131](../slides/for_build/for_engineers.131.jpeg)</label>
_131. Behind the scenes._

Behind the scenes, Kelly's browser has seen that the user wants to load an image. It knows the website it's requesting an image for, and has some cookies for that site (we'll talk more about these in a moment), so it makes the request and sends along the cookies.
...
<input type="checkbox" id="132" /><label for="132">![132](../slides/for_build/for_engineers.132.jpeg)</label>
_132. Logged out._

So the outcome is that Kelly has been logged out from the site, just by visiting an unrelated web page. Now logout isn't necessarily a nefarious action, but this could certainly become annoying for users.

---

### Do it as a POST?

<input type="checkbox" id="133" /><label for="133">![133](../slides/for_build/for_engineers.133.jpeg)</label>
...
<input type="checkbox" id="134" /><label for="134">![134](../slides/for_build/for_engineers.134.jpeg)</label>
...
<input type="checkbox" id="135" /><label for="135">![135](../slides/for_build/for_engineers.135.jpeg)</label>
_135. Panic._
...
<input type="checkbox" id="136" /><label for="136">![136](../slides/for_build/for_engineers.136.jpeg)</label>
...
<input type="checkbox" id="137" /><label for="137">![137](../slides/for_build/for_engineers.137.jpeg)</label>
...
<input type="checkbox" id="138" /><label for="138">![138](../slides/for_build/for_engineers.138.jpeg)</label>
...
<input type="checkbox" id="139" /><label for="139">![139](../slides/for_build/for_engineers.139.jpeg)</label>
...
If you want a vulnerable service to test out your cool exploits, you can run [Rails Goat](https://github.com/OWASP/railsgoat) on your local machine

---

### Revisit The Example

<input type="checkbox" id="140" /><label for="140">![140](../slides/for_build/for_engineers.140.jpeg)</label>
...
<input type="checkbox" id="141" /><label for="141">![141](../slides/for_build/for_engineers.141.jpeg)</label>
...
<input type="checkbox" id="142" /><label for="142">![142](../slides/for_build/for_engineers.142.jpeg)</label>
...
<input type="checkbox" id="143" /><label for="143">![143](../slides/for_build/for_engineers.143.jpeg)</label>
_143. Clickjacking._
...
<input type="checkbox" id="144" /><label for="144">![144](../slides/for_build/for_engineers.144.jpeg)</label>
...
<input type="checkbox" id="145" /><label for="145">![145](../slides/for_build/for_engineers.145.jpeg)</label>
...
<input type="checkbox" id="146" /><label for="146">![146](../slides/for_build/for_engineers.146.jpeg)</label>
...
<input type="checkbox" id="147" /><label for="147">![147](../slides/for_build/for_engineers.147.jpeg)</label>
...
_<input type="checkbox" id="148" /><label for="148">![148](../slides/for_build/for_engineers.148.jpeg)</label>_
...
<input type="checkbox" id="149" /><label for="149">![149](../slides/for_build/for_engineers.149.jpeg)</label>
_149. Definition._
...
<input type="checkbox" id="150" /><label for="150">![150](../slides/for_build/for_engineers.150.jpeg)</label>
...
<input type="checkbox" id="151" /><label for="151">![151](../slides/for_build/for_engineers.151.jpeg)</label>
...
<input type="checkbox" id="152" /><label for="152">![152](../slides/for_build/for_engineers.152.jpeg)</label>
...
<input type="checkbox" id="153" /><label for="153">![153](../slides/for_build/for_engineers.153.jpeg)</label>
_153. ZappiStore account._

Let's look at another example. Let's say I visit the subdomain for a ZappiStore account I suspect exists. It loads the login page. OK great.

---

### Not a ZappiStore Account

<input type="checkbox" id="154" /><label for="154">![154](../slides/for_build/for_engineers.154.jpeg)</label>
_154. Not a ZappiStore account._
...
<input type="checkbox" id="155" /><label for="155">![155](../slides/for_build/for_engineers.155.jpeg)</label>
_155. Confirming accounts._

From this I can infer that the first company has a ZappiStore account, but the latter doesn't. Now this obviously isn't 100% foolproof, nothing says someone has to chose a subdomain that matches their company, in fact a lot don't. But we've actually had competitors exploit this particular behavior in the past in order to identify companies that use us, and then contact those existing customers asking them to switch to their own product! (I know, cheeky right?!)

So why is it still this way? Surely the fix is easy, just show a login page every time. That would indeed solve this issue, but it also presents other problems, as we discovered first-hand. If a customer mistypes their subdomain, then attempts to login, they get login failures. The first assumption is that their account is disabled or ZappiStore isn't working, and they reach out to our support team. Showing a clear error that the subdomain is wrong stops us getting these types of requests, and lets users know that they got the wrong subdomain.
...
<input type="checkbox" id="156" /><label for="156">![156](../slides/for_build/for_engineers.156.jpeg)</label>
...
<input type="checkbox" id="157" /><label for="157">![157](../slides/for_build/for_engineers.157.jpeg)</label>
_157. Be mindful._
...
<input type="checkbox" id="158" /><label for="158">![158](../slides/for_build/for_engineers.158.jpeg)</label>
...
_<input type="checkbox" id="159" /><label for="159">![159](../slides/for_build/for_engineers.159.jpeg)</label>_
...
<input type="checkbox" id="160" /><label for="160">![160](../slides/for_build/for_engineers.160.jpeg)</label>
_160. Definition._
...
<input type="checkbox" id="161" /><label for="161">![161](../slides/for_build/for_engineers.161.jpeg)</label>
...
<input type="checkbox" id="162" /><label for="162">![162](../slides/for_build/for_engineers.162.jpeg)</label>
_162. Stateless._
...
<input type="checkbox" id="163" /><label for="163">![163](../slides/for_build/for_engineers.163.jpeg)</label>
_163. Cookies._
...
<input type="checkbox" id="164" /><label for="164">![164](../slides/for_build/for_engineers.164.jpeg)</label>
...
<input type="checkbox" id="165" /><label for="165">![165](../slides/for_build/for_engineers.165.jpeg)</label>
...
<input type="checkbox" id="166" /><label for="166">![166](../slides/for_build/for_engineers.166.jpeg)</label>
...
<input type="checkbox" id="167" /><label for="167">![167](../slides/for_build/for_engineers.167.jpeg)</label>
...
<input type="checkbox" id="168" /><label for="168">![168](../slides/for_build/for_engineers.168.jpeg)</label>
...
<input type="checkbox" id="169" /><label for="169">![169](../slides/for_build/for_engineers.169.jpeg)</label>
...
<input type="checkbox" id="170" /><label for="170">![170](../slides/for_build/for_engineers.170.jpeg)</label>
...
<input type="checkbox" id="171" /><label for="171">![171](../slides/for_build/for_engineers.171.jpeg)</label>
...
<input type="checkbox" id="172" /><label for="172">![172](../slides/for_build/for_engineers.172.jpeg)</label>
...
<input type="checkbox" id="173" /><label for="173">![173](../slides/for_build/for_engineers.173.jpeg)</label>
...
<input type="checkbox" id="174" /><label for="174">![174](../slides/for_build/for_engineers.174.jpeg)</label>
...
<input type="checkbox" id="175" /><label for="175">![175](../slides/for_build/for_engineers.175.jpeg)</label>
...
<input type="checkbox" id="176" /><label for="176">![176](../slides/for_build/for_engineers.176.jpeg)</label>
...
<input type="checkbox" id="177" /><label for="177">![177](../slides/for_build/for_engineers.177.jpeg)</label>
...
<input type="checkbox" id="178" /><label for="178">![178](../slides/for_build/for_engineers.178.jpeg)</label>
...
<input type="checkbox" id="179" /><label for="179">![179](../slides/for_build/for_engineers.179.jpeg)</label>
...
<input type="checkbox" id="180" /><label for="180">![180](../slides/for_build/for_engineers.180.jpeg)</label>
...
_<input type="checkbox" id="181" /><label for="181">![181](../slides/for_build/for_engineers.181.jpeg)</label>_
_181. Permissions._
...
<input type="checkbox" id="182" /><label for="182">![182](../slides/for_build/for_engineers.182.jpeg)</label>
...
<input type="checkbox" id="183" /><label for="183">![183](../slides/for_build/for_engineers.183.jpeg)</label>
_183. With great power..._

Remember, with great power comes great responsibility. Don't use `sudo` for things where you don't have to. Better yet, don't have the power at all if you don't need it. Use it wisely if you do. A hand to the DevOps team for pushing out the need for most of us to have this capability to break things in an unwanted way. Whoop whoop Kubernetes at Zappi.

---

### Be Mindful of Your Power

<input type="checkbox" id="184" /><label for="184">![184](../slides/for_build/for_engineers.184.jpeg)</label>
_184. "This is too much power for one person"._

You want to always be mindful of how much power you have, and the environment you're wielding it in. If you just need to read some data, try using read-only permissions instead of something that gives you complete administrative access. If you want to really understand this, go ask Don Thompson :-).

---

### Revoke Privileges

<input type="checkbox" id="185" /><label for="185">![185](../slides/for_build/for_engineers.185.jpeg)</label>
...
The Security team runs regular audits and we revoke privileges when we see them not in use :-), but please be pro-active and inform us that you don't need permissions anymore.
---

### Be Mindful

<input type="checkbox" id="186" /><label for="186">![186](../slides/for_build/for_engineers.186.jpeg)</label>
_186. Be mindful._

If you're running some reports on a DB, try a read-only user instead. If you're deleting things from S3, don't use a role that has permissions to delete an EC2 instance, use a role that is limited just to the bucket you need, etc. I am sure most of you are grateful that DevOps has to worry more about this. 

---

### Least Permissive Access

<input type="checkbox" id="187" /><label for="187">![187](../slides/for_build/for_engineers.187.jpeg)</label>
...
_<input type="checkbox" id="188" /><label for="188">![188](../slides/for_build/for_engineers.188.jpeg)</label>_
...
<input type="checkbox" id="189" /><label for="189">![189](../slides/for_build/for_engineers.189.jpeg)</label>
...
<input type="checkbox" id="190" /><label for="190">![190](../slides/for_build/for_engineers.190.jpeg)</label>
...
<input type="checkbox" id="191" /><label for="191">![191](../slides/for_build/for_engineers.191.jpeg)</label>
...
<input type="checkbox" id="192" /><label for="192">![192](../slides/for_build/for_engineers.192.jpeg)</label>
...
<input type="checkbox" id="193" /><label for="193">![193](../slides/for_build/for_engineers.193.jpeg)</label>
...
<input type="checkbox" id="194" /><label for="194">![194](../slides/for_build/for_engineers.194.jpeg)</label>
...
<input type="checkbox" id="195" /><label for="195">![195](../slides/for_build/for_engineers.195.jpeg)</label>
_195. NOP sled._
...
<input type="checkbox" id="196" /><label for="196">![196](../slides/for_build/for_engineers.196.jpeg)</label>
...
<input type="checkbox" id="197" /><label for="197">![197](../slides/for_build/for_engineers.197.jpeg)</label>
...
<input type="checkbox" id="199" /><label for="199">![199](../slides/for_build/for_engineers.199.jpeg)</label>
...
I guess the most popular current ones are the Spectre and Meltdown vulnerabilities.

---

### Side-Channel Attacks Explanations

<input type="checkbox" id="200" /><label for="200">![200](../slides/for_build/for_engineers.200.jpeg)</label>
...
<input type="checkbox" id="201" /><label for="201">![201](../slides/for_build/for_engineers.201.jpeg)</label>
...
_<input type="checkbox" id="202" /><label for="202">![202](../slides/for_build/for_engineers.202.jpeg)</label>_
...
<input type="checkbox" id="203" /><label for="203">![203](../slides/for_build/for_engineers.203.jpeg)</label>
...
<input type="checkbox" id="209" /><label for="209">![209](../slides/for_build/for_engineers.209.jpeg)</label>
_209. Questions?_
...
<input type="checkbox" id="210" /><label for="210">![210](../slides/for_build/for_engineers.210.jpeg)</label>
...
!!!question "Spotted a Problem?"
    Security is hard, and we're not perfect. There may be mistakes or misunderstandings in this training material. If you find a problem, please help us correct it! This project is [managed on GitHub] and we appreciate all friendly contributions.
